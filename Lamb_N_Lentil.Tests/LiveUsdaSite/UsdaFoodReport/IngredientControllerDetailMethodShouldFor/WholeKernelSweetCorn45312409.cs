...
{
    [TestClass]
    public class WholeKernelSweetCorn45312409 : IngredientControllerDetailMethodShould
    { 
        ...
        { 
            var correct = "WHOLE KERNEL SWEET CORN, UPC: 037100036622";
        ...
        { 
            var correct = "CORN, WATER AND SALT.";
