...
{   
    [TestClass]
    public class LiveUsdaAsyncShouldReturnValidFoodReportForKrogerBlendedGradeALowFatStrawberryYogurtUPC011110452979 : LiveUsdaAsyncShouldReturnValidFoodReportWhen
    { 
        [TestInitialize]
